...
cursor.execute("""
INSERT INTO tutorial (title, description, category, steps, step_images, user_id)
VALUES ('No Makeup Look - Natural Glow', 'A simple no makeup look for everyday natural beauty', 'No Makeup Look', '["Moisturizer", "Sunscreen or Tinted Sunscreen", "Blush", "Lipstick"]', '["https://example.com/nomakeup1-step1.jpg", "https://example.com/nomakeup1-step2.jpg"]', 1)
""")

# No Makeup Look - Tutorial 2
cursor.execute("""
INSERT INTO tutorial (title, description, category, steps, step_images, user_id)
VALUES ('No Makeup Look - Fresh and Dewy', 'A fresh and dewy no makeup look for a youthful appearance', 'No Makeup Look', '["Moisturizer", "Sunscreen or Tinted Sunscreen", "Blush", "Lipstick"]', '["https://example.com/nomakeup2-step1.jpg", "https://example.com/nomakeup2-step2.jpg", "https://example.com/nomakeup2-step3.jpg"]', 1)
""")
...
cursor.execute("""
INSERT INTO tutorial (title, description, category, steps, step_images, user_id)
VALUES ('Douyin Makeup Tutorial - Trendy Eyes', 'A trendy eye makeup tutorial popular on Douyin', 'Douyin Makeup', '["Contact Lens", "Eyeshadow", "Eyeliner"]', '["https://example.com/douyin1-step1.jpg", "https://example.com/douyin1-step2.jpg", "https://example.com/douyin1-step3.jpg"]', 1)
""")
